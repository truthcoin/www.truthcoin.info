...
<h3 id="6">6. The "BIP Process" isn't enough.</h3>
...
* In any event: it is too late. Soft forks now take years[^30], and the damage done by the overlarge Blocksize is already being done[^8], each day.
