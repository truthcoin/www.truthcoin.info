---
title: BitUSD Is Inferior To Its Competitors
comments: true
---

> BitUSD, as currently imagined, is inferior not only to Bitcoin but also to the real USD. A superior BitUSD may emerge in Truthcoin as a result of the USD's inability to be used in prediction markets.
...
## Is BitUSD Useful?
> BitUSD is not useful for spending, where it is permanently inferior to (Bitcoin + Bitpay) and the real USD. BitUSD is only useful as a mixed-bet investment: pro blockchain-tech, but against Bitcoin's exchange infrastructure and monetary policy. 
...
Merchants are parts of large networks (suppliers, owners, employees, customers) and do not acquire marketable assets (those accrue to their owners). As a result, they cannot easily coordinate a network-scale payment system upgrade. **Merchants need USD, they can use Bitpay** (which integrates with existing supplier/banking networks).

And, as [previously written](http://www.truthcoin.info/blog/basics/), if BitPay were to enable merchants to accept both Bitcoin and BitUSD, this would only deepen Bitcoin's advantage as an electronic value-storer, which would be disastrous for BitUSD's utility (more on the Bitcoin vs BitUSD investment-decision later).



### The "Bitcoin Put"

BitUSD, then, solves the problem of **value risk**. BitUSD is *insurance*, which protects users from bearing "too many" risks. Individuals are willing to invest in the blockchain payment technology, but they do not necessarily also want to invest in: [1] a new and volatile currency-system, [2] the first completely virtual ("un-backed") digital money, or [3] the pseudogold monetary policy of Bitcoin (21 million coins, released every 10 minutes, halving every 4 years, etc). It's a lot of risk to bear at once, and BitUSD allows users to separate those risks.

### BitUSD: Useful for Savers, Not Spenders
...
> A BitUSD worth exactly 1 dollar is simultaneously inferior to both Bitcoin and the USD.  BitUSD is risky for savers, and all risk must be compensated by return. This return must be set dynamically by free exchange in order for the BitUSD market to clear over time.

Even assuming that BitUSD were only used for saving, it would still have many disadvantages to the USD:

* Other Users Do Not Recognize BitUSD as Money
* Merchants Do Not Accept BitUSD (and have no reason to)
...
Let's examine another shortcoming of the traditional BitUSD of BitsharesX and SchellingCoin: the dangerous and neurotic way it "checks in" with the world to get an update on the BTC/USD exchange rate.
...
Above: USD Market, priced in BTC (unconventional y-axis direction) to illustrate the concept of "cheaper than normal" BitUSD in the Truthcoin case (blue dots). Over time, the lines converge. For BitsharesX, I emphasize the "guard-rails" in the feed provided by delegates.

![Title](/images/BitUsdCheckIns.jpg)

Above: “Check-in” events: BitsharesX (green squares) asks each delegate to report constantly, as does SchellingCoin (yellow circles). In contrast, the Truthcoin BitUSD (blue triangle) would wait much longer between reports (several weeks or months).
...
Truthcoin's seemingly long check in time (of several weeks or months) [is a frequent point of confusion for new readers](https://github.com/truthcoin/www.truthcoin.info/blob/gh-pages/faq/index.md#in-some-of-your-notes-you-suggested-timelines-of-a-couple-of-weeks-for-voting-would-it-be-fair-to-say-this-wouldnt-be-suitable-to-horse-racing-etc-where-the-events-happen-very-fast-there-are-many-of-them-and-payouts-need-to-be-made-fairly-quickly).


( This obsession, while understandable, is as ridiculous as the obsession with Bitcoin's supposedly "slow" 10 minute interblock-time. Newsflash: it is "bottlenecks in information transfer/processing" [bandwidth, computing speed, etc.] which determine **the** blocktime, not designers. Cutting the interblock-time to 2.5 minutes doesn't answer the essential question: "Am I getting paid or what?", just as counting in seconds instead of minutes doesn't speed the flow of time. )
...
#### Frequent Check-Ins: No Flexibility, No Market, No Return


Even Vitalik Buterin has followed the siren music to his peril with the [SchellingCoin](https://blog.ethereum.org/2014/03/28/schellingcoin-a-minimal-trust-universal-data-feed/), by "checking in" every other block, a **staggering** redundancy and security threat.

( In addition, I might add, SchellingCoin rather *completely misuses* the Schelling [Focal Point concept](http://en.wikipedia.org/wiki/Focal_point_%28game_theory%29) [users are **not at all** indifferent among their choices, and they definitely have the ability to enter and leave the game (a decision to which they are definitely not indifferent). I humbly assert that [my own work](http://www.truthcoin.info/papers/truthcoin-whitepaper.pdf) uses the concept more reasonably. )


## Conclusion

The BitUSD joins the long list of "mindless hype" crypto-projects. While contemporary BitUSD concepts do not actually meet any consumer-need, a different BitUSD might emerge in Truthcoin from the USD's inability to be used in prediction markets.
